...
Generated: 2025-11-13T12:52:35.171523
"""
...
def build_full_pipeline():
    ...
    # best_rf = RandomForestClassifier(n_estimators=200, max_depth=20, min_samples_split=2, min_samples_leaf=1, bootstrap=True, random_state=42)
    # model = best_rf
