...
Dataset: digits
Generated: 2025-11-13T12:56:12.854414
"""
...
def build_full_pipeline():
    ...
    feature_engineering = Pipeline([
        ('pca', PCA(n_components=20, random_state=42)) # Chosen 20 components as a reasonable reduction
    ])
    ...
    model = SVC(C=10, gamma=0.01, kernel='rbf', random_state=42) # Chosen best model with tuned hyperparameters
