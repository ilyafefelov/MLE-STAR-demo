...
spec = importlib.util.spec_from_file_location('gemini_live_california-housing-prices', str(Path(__file__).with_name('gemini_live_california-housing-prices.py')))
