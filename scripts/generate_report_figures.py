#!/usr/bin/env python
"""
Generate report-ready figures from aggregated reports.

Usage:
  python scripts/generate_report_figures.py --table1 reports/table1_model_comparison.csv --table2 reports/table2_ablation.csv --out reports/figures
"""
import argparse
