...
def main():
    ...
    subprocess.run([args.python, 'scripts/generate_thesis_figures.py', '--table1', 'reports/table1_model_comparison.csv', '--table2', 'reports/table2_ablation.csv', '--out', 'reports/figures'])
